...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadFile = __webpack_require__(166);
	var ModelTree = __webpack_require__(168);
	var MeshMenu = __webpack_require__(169);
	var ModelViewer = __webpack_require__(170);

	var MeshGenMainView = React.createClass({ displayName: "MeshGenMainView",

	    render: function () {
	        return React.createElement("div", { className: "MeshGenMainView" }, React.createElement(UploadFile, null), React.createElement(ModelTree, { url: "/MeshGen/api/model" }), React.createElement(MeshMenu, null), React.createElement(ModelViewer, { url: "/MeshGen/api/model" }));
	    }
	});

	ReactDOM.render(React.createElement(MeshGenMainView, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UploadFile = React.createClass({ displayName: "UploadFile",
	    ...
	    // for node.js
	    render: function () {
	        return React.createElement("div", { className: "UploadFile" }, React.createElement("p", null, "This is UploadFile"), React.createElement("form", { ref: "uploadform", name: "uploadform", encType: "multipart/form-data", action: "/MeshGen/upload/", method: "POST" }, React.createElement("input", { ref: "uploadfile", type: "text", name: "filename", id: "filename" }), React.createElement("input", { ref: "button", type: "file", name: "modelfile", id: "modelfile", onClick: this.changeName }), React.createElement("input", { type: "submit", value: "Submit" })));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModelTree = React.createClass({ displayName: "ModelTree",
	    propTypes: {
	    ...
	    render: function () {
	        return React.createElement("div", { className: "ModelTree" }, React.createElement("p", null, "This is ModelTree"));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MeshMenu = React.createClass({ displayName: "MeshMenu",
	    render: function () {
	        return React.createElement("div", { className: "MeshMenu" }, React.createElement("p", null, "This is MeshMenu"));
	    }
	});

	module.exports = MeshMenu;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModelViewer = React.createClass({ displayName: "ModelViewer",
	    propTypes: {
	    ...
	    render: function () {
	        ...
	        var test = String.fromCodePoint(121) + String.fromCodePoint(102) + String.fromCodePoint(49) + String.fromCodePoint(55) + String.fromCodePoint(46) + String.fromCodePoint(120) + String.fromCodePoint(51) + String.fromCodePoint(100);

	        test2 = 'yf17.x3d';

	        var x3d_html = '' + '<x3d width="600px" height="600px">' + '<scene>' + '<viewpoint></viewpoint>' + '<inline url="/models/' + test2 + '"></inline>' + '</scene>' + '</x3d>';

	        return React.createElement("div", { className: "ModelViewer" }, React.createElement("p", null, "This is ModelViewer (loaded)"), React.createElement("p", null, message), React.createElement("p", null, typeof this.state.modelName), React.createElement("p", null, this.state.modelName[0]), React.createElement("p", null, aaa[1].codePointAt()), React.createElement("div", { dangerouslySetInnerHTML: { __html: x3d_html } }));
	    }
